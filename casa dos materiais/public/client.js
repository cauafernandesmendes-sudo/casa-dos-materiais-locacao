  ...
  function showEquipmentDetails(equipmentId) {
    ...
    document.getElementById('contractContent').innerHTML = `
      <div style="display:grid;grid-template-columns:180px 1fr;gap:20px;align-items:start">
        <img src="${escapeHtml(safeImage(item.image))}" alt="${escapeHtml(item.name)}" onerror="this.onerror=null;this.src='assets/photos/ferramentas.jpg'" style="width:100%;height:180px;object-fit:contain;border-radius:12px;background:#ffffff;padding:8px">
